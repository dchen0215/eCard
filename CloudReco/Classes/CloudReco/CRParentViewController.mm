...
- (void)loadView
{
    ...
    [overlayViewController.view addGestureRecognizer:gesture];
    [gesture release];
...
- (void)gestureRecognized:(UISwipeGestureRecognizer *)gesture
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"dismissRecognizeAR" object:nil];
}
